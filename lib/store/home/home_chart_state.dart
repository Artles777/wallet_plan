...
abstract class _HomeChartState with Store {
  ...
  @observable
  ObservableList<CategoryIcon>
  categoriesList = ObservableList<CategoryIcon>.of([
    CategoryIcon(name: "products", icon: Icons.restaurant, color: Colors.black),
    CategoryIcon(name: "products", icon: Icons.restaurant, color: Colors.amber),
    CategoryIcon(name: "products", icon: Icons.restaurant, color: Colors.amber),
    CategoryIcon(name: "products", icon: Icons.restaurant, color: Colors.amber),
    CategoryIcon(name: "products", icon: Icons.restaurant, color: Colors.amber),
    CategoryIcon(name: "products", icon: Icons.restaurant, color: Colors.amber),
  ...
  void openChartSettings(BuildContext context) {
    context.goNamed("${HomeRouterNames.editCharts}");
  }
